...
@include('pdf.bootstrap')
  ...
  <div class="">
    ...
    <br/><br/>
    <div class="row">
    	<h3 class="title text-center">BON DE COMMANDE N&deg{{$num}}/PDG/DAA/CAA{{$tete}}/{{$y}}</h3>
    </div>
    <br/><br/>
    <div class="row">
    ...
    <div class="row">
    	<h3><span class="title" style="margin-left:11%;">FOURNISSEUR</span> :{{$fournisseur}}</h3>
      <input type="hidden" value="{{$fournisseur}}" name="fournisseur">
    </div>
    <div class="row">
      ...
      <input type="hidden" value="{{$taux_avance}}" name="taux_avance">
      <input type="hidden" value="{{$delais}}" name="delais">
    </div>
    <br/><br/>
    <div class="row">
...
<div class="col-md-offset-2 col-md-2">
        <div class="form-group">
           ...
           <a href="{{route('BonCommande.create',['user'=>$user])}}" class="btn btn-default" style="height:50px;width:100px">REFAIRE</a>
           </div>
          </div>
