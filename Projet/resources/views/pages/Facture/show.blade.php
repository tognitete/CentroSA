...
<div class="container" style="width:1000px">
    <div class="well">
     ...
     <div class="row">
        ...
        <p><h4><span class="title">MONTANT AVANCE:</span ><span class="orange"> {{FactMoney($avance)}} FCFA</h4></span></p><br/><br/> 
...
<div class="row">
  <div class="col-md-offset-5 col-md-2">
        <br/><a   href="javascript:history.go(-1);" name="obj_eng" class="btn btn-success "  style="height:50px;width:100px;">OK</a>
        <div class="col-md-offset-5 col-md-2">
