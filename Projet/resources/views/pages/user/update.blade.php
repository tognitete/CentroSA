...
<div class="container">
    <div class="well">
        ...
        <h1 class="title text-center">MODIFICATION DES INFORMATIONS D'UN UTILISATEUR</h1>
        ...
        <div class="row">
            ...
            <div class="form-group">
              ...
              <select id="nom" name="nom" class="form-control" onchange="s_user()">
                <option></option>
      ...
      <div class="row">
            <div class="col-md-offset-2 col-md-8"> 
            <div class="form-group">
              <label for="n_nom">Nouveau Nom</label>
              <input type="text" name="n_nom" id="n_nom"  class="form-control" placeholder="Nouveau nom de l'Utilisateur">
    ...
    <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="password" name="mdp" id="mdp"  class="form-control" placeholder="Nouveau mot de passe">
      ...
      <div class="row">
            ...
            <div class="form-group">
              ...
              <input type="password" name="cmdp" id="cmdp"  class="form-control" placeholder="Confirmation du mot de passe">
