  ...
  $( function() {
      ...
      buttons: {
       "NON": function() {
          ...
          document.getElementById('designation_ute').value="#";
          $("#form").submit();
        },
        "OUI ": function() {
          $( this ).dialog( "close" );
...
<form action="{{route('ute.store')}}" method="POST" id="form">
  {{csrf_field()}}
     ...
     <img src="../images/logo.png" style="width:100px;margin-left:-20px" alt="logo de CENTRO" class="img-rounded">
        ...
        <div class="row">
            ...
            <div class="form-group">
              <label for="designation_ute">Deignation</label>
              <input type="hidden" name="url" value="{{$url}}">
              <input type="text" name="designation_ute" id="designation_ute" class="form-control" placeholder="Nom de l'UTE">
       ...
       <br/>
        <div class="col-md-2">
        <div class="form-group">
           <input type="submit" style="height:42px;" name="obj_eng" class="btn btn-success " value="ENREGISTRER &raquo">
