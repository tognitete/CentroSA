...
<form action="" method="POST">
  {{csrf_field()}}
  <div class="group">
    <input type="text" name="utilisateur"><span class="highlight"></span><span class="bar"></span>
    <label>Utilisateur</label>
  </div>
  <div class="group">
    <input type="password" name="mdp"><span class="highlight"></span><span class="bar"></span>
